...
const Dashboard = ({ subscriptionPlane }: PageProps) => {
  ...
  const { mutate: deleteFile } = trpc.deleteFile.useMutation({
    ...
    onMutate({id}){
      setCurrentlyDeletngFile(id)
    },
    onSettled(){
      setCurrentlyDeletngFile(null)
    }
  })
  ...
  return (
    <main className="mx-auto container max-w-7xl md:p-10">
      <div className="mt-8 flex flex-col items-start justify-between gap-4 border-b border-gray-200 pb-5 sm:flex-row sm:items-center sm:gap-0">
        ...
        <UploadButton isSubscribed={subscriptionPlane.isSubscribed} />
      </div>
                ...
                >
                  ...
                  >
                    <div className="pt-6 px-6 flex w-full items-center justify-between space-x-6">
                      <div className="h-10 w-10 flex-shrink-0 rounded-full bg-gradient-to-r from-blue-200 to-violet-500" />
